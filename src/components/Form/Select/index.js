...
import addGlobalEvent from 'utils/trigger';
...
export default class Select extends React.Component {
  ...
  componentDidMount() {
    ...
    this.removeGlobalEvent = addGlobalEvent('click', (pointer) => {
  ...
  componentWillUnmount() {
    this.removeGlobalEvent && this.removeGlobalEvent();
    this.unDeposit();
  }

  componentWillReceiveProps(nextProps) {

    if (!similarArray(nextProps.options, this.props.options) || this.props.defaultValue != nextProps.defaultValue) {
